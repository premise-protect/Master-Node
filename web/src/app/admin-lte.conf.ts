export const adminLteConf = {
  ...
  // ]
  sidebarLeftMenu: [
    {label: 'ACCESS CONTROL', separator: true},
    {label: 'Users', iconClasses: 'fa fa-user'},
    {label: 'Access Groups', iconClasses: 'fa fa-group'},
    {label: 'Tokens', iconClasses: 'fa fa-id-card'},
    {label: 'FACILITIES', separator: true},
    {label: 'Inputs', iconClasses: 'fa fa-key'},
    {label: 'Outputs', iconClasses: 'fa fa-lock'},
    {label: 'Controllers', iconClasses: 'fa fa-bolt'},
    {label: 'SYSTEM', separator: true},
    {label: 'Global Config', iconClasses: 'fa fa-cog'}
  ]
};
